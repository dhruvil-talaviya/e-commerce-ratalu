...
export function OrderTimeline({
  ...
  const steps = [
    ...
    },
    {
      id: "confirmed",
      title: "Confirmed",
      done: ["Confirmed", "Preparing", "Packed", "Ready to Ship", "Assigned to Logistics", "Shipped", "Out for Delivery", "Delivered", "Completed"].includes(orderStatus) || Boolean(confirmedAt),
    ...
    },
    {
      id: "packed",
      title: "Packed",
      done: ["Packed", "Ready to Ship", "Assigned to Logistics", "Shipped", "Out for Delivery", "Delivered", "Completed"].includes(orderStatus) || Boolean(packedAt),
    ...
    },
    {
      id: "shipped",
      title: "Shipped",
      done: ["Assigned to Logistics", "Shipped", "Out for Delivery", "Delivered", "Completed"].includes(orderStatus) || Boolean(shippedAt),
