...
// lucide dropped its brand marks over trademark concerns — which is why the
// custom SVGs below exist. Only generic glyphs are imported here.
import { Send, Ghost, MessageCircle, Mail, Phone, Link2, AtSign, Briefcase } from "lucide-react";
...
/** Human labels — used for the accessible name on each icon link. */
...
/**
 * Draw whichever platform the admin enabled.
 *
 * The footer previously hardcoded four icons, so adding LinkedIn or Telegram in
 * the console produced a row nothing could render. Every platform the
 * SocialLink model accepts has an icon here; anything unrecognised falls back to
 * a generic link rather than rendering nothing.
 */
