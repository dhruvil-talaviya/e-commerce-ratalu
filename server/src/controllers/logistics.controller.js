...
// @desc    Shiprocket Realtime Webhook Receiver (Delegated to dedicated webhook controller)
// @route   POST /api/v1/logistics/webhook
// @access  Public
const { handleShiprocketWebhook } = require('./webhook.controller');
exports.handleShiprocketWebhook = handleShiprocketWebhook;
exports.shiprocketWebhook = handleShiprocketWebhook;
